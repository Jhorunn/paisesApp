...
//
//   const rESTCoubtriesResponse = Convert.toRESTCoubtriesResponse(json);
//
...
export class Convert {
  public static toRESTCoubtriesResponse(json: string): Country[] {
      return cast(JSON.parse(json), a(r("RESTCoubtriesResponse")));
  }

  public static rESTCoubtriesResponseToJson(value: Country[]): string {
      return JSON.stringify(uncast(value, a(r("RESTCoubtriesResponse"))), null, 2);
  }
}
